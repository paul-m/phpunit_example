...
// @todo: Remove this once this is resolved: https://drupal.org/node/2025883
require_once('Subclasses/ProtectedPrivatesSubclass.php');
...
class Reflection_ProtectedPrivatesTest extends UnitTestCase {
  ...
  public function testProtectedAdd($a, $b, $expected) {
    ...
    $this->assertEquals($stub->sub_protectedAdd($a, $b), $expected);
  }
